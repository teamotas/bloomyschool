...
$programs = [
    ...
    "playgroup" => [
        ...
        "desc1" => "Our playgroup program in Sahibabad focuses on social interaction, creativity and communication through fun activities.",
        "desc2" => "Children learn through music, storytelling and group play while building confidence and independence.",
    ...
    "nursery" => [
        ...
        "desc1" => "Nursery program introduces alphabets, numbers and creativity through structured activities.",
        "desc2" => "We focus on communication, discipline and learning habits in a fun environment.",

        "requirements_head" => "A strong foundation program for early academics.",
        "requirements" => [
    ...
    "junior-kg" => [
        ...
        "desc1" => "Junior KG develops reading, writing and basic math skills through structured learning.",
        "desc2" => "We build discipline, confidence and independent learning habits.",

        "requirements_head" => "Prepares children for advanced learning stages.",
        "requirements" => [
            "Recognition skills",
            "Routine following",
            "Books required",
    ...
    "senior-kg" => [
        ...
        "desc1" => "Senior KG focuses on language, math and logical thinking skills.",
        "desc2" => "Children gain independence and strong academic readiness.",

        "requirements_head" => "Final stage before primary education.",
        "requirements" => [
    ...
    "day-care" => [
        ...
        "desc1" => "Bloomy Preschool provides safe daycare with full supervision and care.",
        "desc2" => "Includes play, meals, learning and rest in a home-like environment.",

        "requirements_head" => "Designed for working parents needing full-day care.",
        "requirements" => [
            "Meals",
            "Emergency contact",
            "Daily essentials",
